...
// You can repeat the same pattern for all the other components:
// SidebarRail, SidebarInset, SidebarInput, SidebarHeader, SidebarFooter,
// SidebarSeparator, SidebarContent, SidebarGroup, SidebarGroupLabel, SidebarGroupAction,
// SidebarGroupContent, SidebarMenu, SidebarMenuItem, SidebarMenuButton, SidebarMenuAction,
// SidebarMenuBadge, SidebarMenuSkeleton, SidebarMenuSub, SidebarMenuSubItem, SidebarMenuSubButton

// The pattern is: remove all TypeScript types and keep plain JS props & destructuring.
