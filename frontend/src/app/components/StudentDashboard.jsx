...
import { Home, Plus, Users, Heart } from 'lucide-react';
        ...
        <TabsContent value="requests" className="mt-6">
          <div className="space-y-4">
            ...
            {bookingsLoading ? (
              ...
              <Card>
                <CardContent className="p-8 text-center text-gray-500">
                  No booking requests yet. Start exploring listings!
                </CardContent>
              </Card>
            ) : (
                  ...
                  <CardContent className="p-6">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        {booking.message && (
                          <p className="text-sm text-gray-600 mt-2">Your Message: {booking.message}</p>
                        )}
                        <div className="mt-2">
                          <Badge 
                            variant={
                      ...
                      <Button onClick={() => navigate(`/listing/${booking.listing_id}`)}>
                        View Listing
                      </Button>
                    </div>
                  </CardContent>
